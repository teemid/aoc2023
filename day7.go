...
func printHand(hand *Hand) {
    ...
    switch handType {
        case FIVE_OF_A_KIND: fmt.Printf("Five of a kind")
        case FOUR_OF_A_KIND: fmt.Printf("Four of a kind")
        case FULL_HOUSE: fmt.Printf("Full house")
        case THREE_OF_A_KIND: fmt.Printf("Three of a kind")
        case TWO_PAIR: fmt.Printf("Two pair")
        case ONE_PAIR: fmt.Printf("One pair")
        case HIGH_CARD: fmt.Printf("High card")
    }
    ...
    for i := 0; i < 5; i++ {
        ...
        fmt.Printf(" ")
        switch v {
            case 14: fmt.Printf("A")
            case 13: fmt.Printf("K")
            case 12: fmt.Printf("Q")
            case 11: fmt.Printf("J")
            case 10: fmt.Printf("T")
            case 1: fmt.Printf("J")
            default: fmt.Printf("%d", v)
        }
    } 
